<template>
  ...
  <div class="all_user_list">
    <div class="col-12">
      <h3 class="mb-3 pb-3 pb-md-4 mb-md-4 mt-3 mt-md-4 text-primary">Edit Group</h3>
    </div>
    ...
    <div class="col-12">
      ...
      <div class="row mt-4">
        <div class="col-md-1">
          <button type="button" @click="createGroup" class="btn btn-success">Update
          </button>
        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            createGroup() {
                ...
                if (this.$v.$invalid) {
                    ...
                    this.axios.put(this.$servername + '/groups/' + this.$route.params.id, formObj)
                        .then((response) => {
        ...
        mounted() {
            this.axios.get(this.$servername + "/groups/" + this.$route.params.id).then(response => {
                console.info('response: ', response);
